      ...
      translation: {
        ...
        settings: {
          ...
          about: {
            title: "About",
            version: "Version",
            description: "Host Genius is a powerful hosts file management tool",
          },
          general: {
            title: "General",
      ...
      translation: {
        ...
        hosts: {
          ...
          systemView: {
            ...
            noResults: 'Nenhuma entrada de host encontrada contendo "{{term}}"',
      ...
      translation: {
        ...
        hosts: {
          ...
          systemView: {
            ...
            clearSearch: "検索をクリア",
            noEntries: "システムhostsファイルに有効なhostsエントリがありません",
            emptyFile: "(ファイルが空です)",
            status: "ステータス",
